...
solving symbolic equations and making plots, and interfacing Python
...
\cvitem{2019}{\textbf{F. Bartoli\'{c}} et. al. (in prep). Paper on 
building a hierarchical Bayesian model for astrophysical time 
series prediction.}
\cvitem{2019}{\textbf{F. Bartoli\'{c}} et. al. (in prep). 
Paper on Bayesian modeling of microlensing events using Gaussian Processes 
